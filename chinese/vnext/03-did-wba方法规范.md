...
- 标题：did:wba方法规范
- 状态：草案 / 未发布
- 已发布基线：[ANP-03 v1.1](../03-did-wba方法规范.md)
- 语言：中文
- 适用范围：本规范适用于 ANP 中基于 Web 的去中心化身份、跨平台身份认证与智能体通信场景。

> 草案说明：本文件是 ANP 1.1 的候选方法修订；通用认证现由 ANP-02 拥有。在本草案正式发布前，不得将其视为已发布协议。英文镜像为 [did:wba Method Specification](../../vnext/03-did-wba-method-design-specification.md)。
